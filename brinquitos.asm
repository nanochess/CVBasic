	; CVBasic compiler v0.8.0 Nov/12/2024
	; Command: ./cvbasic --sg1000 examples/brinquitos.bas brinquitos.asm 
	; Created: Mon Apr 14 12:13:08 2025
...
STACK:	equ $c400	; Base stack pointer
...
cv1:
	...
	; 	cloud_y(3) = 176
	LD A,176
	LD (array_CLOUD_Y+3),A
	; 	cloud_y(2) = 126
	LD A,126
	LD (array_CLOUD_Y+2),A
	; 	cloud_y(1) = 76
	LD A,76
	LD (array_CLOUD_Y+1),A
	; 	cloud_y(0) = 26
	LD A,26
	LD (array_CLOUD_Y),A
	; 
	; 	cloud_x(3) = 128
	LD A,128
	LD (array_CLOUD_X+3),A
	; 	cloud_e(3) = 0
	SUB A
	LD (array_CLOUD_E+3),A
	; 
	; 	c = 2
	LD A,2
	LD (cvb_C),A
	; 	GOSUB setup_cloud
	CALL cvb_SETUP_CLOUD
	; 	c = 1
	LD A,1
	LD (cvb_C),A
	; 	GOSUB setup_cloud
	...
	LD A,3
	LD (cvb_STANDING_ON),A
	; 
	; 	PLAY SIMPLE
	LD A,3
	LD (music_mode),A
	; 	PLAY music_gladiators
	LD HL,cvb_MUSIC_GLADIATORS
	CALL music_play
	; 
	; 	'
	; 	' Main loop
...
cvb_END_OF_GAME:
	...
	JP cv28
cv27:
	DB $47,$20,$41,$20,$4d,$20,$45,$20
	DB $20,$20,$4f,$20,$56,$20,$45,$20
	DB $52
cv28:
	; 
	; 	FOR c = 1 TO 240
...
cvb_SPRITES_BITMAPS:
	...
	; 	BITMAP "....XXX..XXX...."
	; 	BITMAP "...XXXX..XXXX..."
	DB $00,$00,$00,$03,$07,$0f,$19,$19
	DB $3f,$7d,$d3,$d8,$df,$e6,$0e,$1e
	DB $00,$00,$00,$c0,$e0,$f8,$98,$98
	DB $fc,$be,$cb,$1b,$fb,$67,$70,$78
	; 
	...
	; 	BITMAP ".....XX..XX....."
	; 	BITMAP "....XXX..XXX...."
	DB $60,$e0,$e3,$67,$69,$59,$5f,$3d
	DB $13,$19,$1c,$1f,$06,$06,$06,$0e
	DB $06,$07,$c7,$e6,$96,$9a,$fa,$bc
	DB $c8,$98,$38,$f8,$60,$60,$60,$70
	; 
	...
	; 	BITMAP ".....XX..XX....."
	; 	BITMAP "....XXX..XXX...."
	DB $60,$e3,$67,$69,$59,$5f,$3d,$1e
	DB $18,$1c,$1f,$06,$06,$06,$06,$0e
	DB $06,$c7,$e6,$96,$9a,$fa,$bc,$78
	DB $18,$38,$f8,$60,$60,$60,$60,$70
	; 
	...
	; 	BITMAP "................"
	; 	BITMAP "................"
	DB $3b,$7d,$7e,$e6,$dc,$3b,$7b,$7b
	DB $3c,$00,$00,$00,$00,$00,$00,$00
	DB $a0,$d8,$ec,$ec,$e4,$18,$bc,$be
