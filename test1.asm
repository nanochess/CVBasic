	...
	; Command: ./cvbasic -Dmyconst=7 test1.bas test1.asm 
	; Created: Thu May  1 22:53:44 2025
...
.4:
	...
	JP cv2
cv1:
	DB $54,$68,$65,$20,$63,$6f,$6e,$73
	DB $74,$61,$6e,$74,$20,$69,$73,$20
cv2:
	LD HL,7
	CALL print_number
	; 
