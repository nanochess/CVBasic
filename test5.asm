	...
	; Command: ./cvbasic --sgm examples/test5.bas test5.asm 
	; Created: Fri Jul 24 15:26:00 2026
...
BASE_RAM:	equ $7c00	; Base of RAM
RAM_SIZE:	equ $5c00	; Base of RAM
STACK:	equ $8000	; Base stack pointer
...
.4:
	...
	JR cv2
cv1:
	DB $43,$6f,$6d,$70,$69,$6c,$65,$64
	DB $20,$66,$6f,$72,$20,$53,$47,$4d
cv2:
	; #endif
	; 
	; #if COLECOVISION
	...
	JR cv4
cv3:
	DB $54,$68,$69,$73,$20,$69,$73,$6e
	DB $27,$74,$20,$61,$20,$43,$6f,$6c
	DB $65,$63,$6f,$76,$69,$73,$69,$6f
	DB $6e
cv4:
	; #endif
	; 
	...
	JR cv6
cv5:
	DB $59,$65,$70,$21,$20,$49,$74,$20
	DB $69,$73,$20,$61,$20,$53,$47,$4d
cv6:
	; #else
