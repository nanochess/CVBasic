...
.4:
	...
	; 	OPTION EXPLICIT ON
	; 
	; 	DIM lives, level, base_character
	; 	DIM x_player, y_player, player_frame
	; 	DIM x_enemy1, y_enemy1, enemy1_frame
	; 	DIM x_enemy2, y_enemy2, enemy2_frame
	; 	DIM x_enemy3, y_enemy3, enemy3_frame
	; 	DIM enemy_speed
	; 	DIM c, #c, d, #d, e
	; 	DIM ladders, column, row
	; 	DIM tick_note, song_note, note
	; 
